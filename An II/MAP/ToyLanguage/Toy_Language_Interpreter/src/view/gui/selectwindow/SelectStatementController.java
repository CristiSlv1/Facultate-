...
public class SelectStatementController implements Initializable {
    ...
    private void populateStatements()
    {
        ...
        /*6 Ref int v; new(v,20); Ref Ref int a; new(a,v); print(rH(v)); print(rH(rH(a))+5) */
        ...
        //10 int v; Ref int a; v=10; new(a,22); fork(wH(a,30); v=32; print(v); print(rH(a))); print(v); print(rH(a))
